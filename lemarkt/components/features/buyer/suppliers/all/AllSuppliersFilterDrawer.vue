...
<script setup lang="ts">
    ...
    const businessTypeOptions = computed(() => {
        return userDashboardStore.suppliersFilterOptions?.business_types || []
    })

    const countryOptions = computed(() => {
        return userDashboardStore.suppliersFilterOptions?.countries || []
    })
    ...
    const initializeFilterData = async (): Promise<void> => {
        ...
        try {
            ...
            console.error('Failed to initialize suppliers filter data:', error)
